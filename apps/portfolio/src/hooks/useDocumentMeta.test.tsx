...
test("sets hreflang alternate links for both locales plus x-default, from the current route", () => {
  ...
  expect(en).toHaveAttribute("href", "https://luanncurioso.dev/resume?lang=en");
  expect(ptBR).toHaveAttribute(
    "href",
    "https://luanncurioso.dev/resume?lang=pt-BR"
  );
  expect(xDefault).toHaveAttribute("href", "https://luanncurioso.dev/resume");
});
