...
// Path data from @fortawesome/free-brands-svg-icons' faLinkedinIn, extracted
// directly rather than re-sourced, to guarantee an exact match to what was
// already rendering. Copied from apps/portfolio's icon of the same name —
// duplicated rather than shared, same precedent as useTheme/ThemeToggle.
const PATH =
...
export default function LinkedinIcon({ className }: { className?: string }) {
  return <Icon viewBox="0 0 448 512" path={PATH} className={className} />;
}
